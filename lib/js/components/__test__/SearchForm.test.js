...
describe('SearchForm', () => {
  ...
  it('should call dispatch method dispatchInput correctly with input more than 3 chars', () => {
  ...
  it('should call dispatch method dispatchInput correctly with input less than 3 chars', () => {
    const dispatch = jest.fn();
    const mockedEvent = Object.assign(jest.fn(), {
      preventDefault: () => {},
      target: { value: 'te' },
